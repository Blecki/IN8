...
namespace IN8
{
    ...
    public class ICM : Hardware
    {
        ...
        public String DebugString { get { return String.Format("ICM DMODE:{0:X2} MEMSEC:{1:X2} DPORT:{2:X2} MPORT:{3:X2}", currentMode, memory_map_start, dataPort, controlPort); } }

        public void InitializeGraphics(GraphicsDevice device, Microsoft.Xna.Framework.Content.ContentManager Content)
        {
            this.device = device;
        ...
        public Point PreferredSize { get { return new Point(528, 528); } }
